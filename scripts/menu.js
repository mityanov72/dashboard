function createMenu() {
	...
	MENU.innerHTML = '<table class="menu_button"><tr>'+
		'<td width="40px"><a class="menu_button" href="#" onclick="Application.open(\'PAGE_MAIN\'); return false;">&#9776;</a></td>'+
		'<td id="page_title">Main Page</td>'+
		'<td width="40px"><a class="menu_button" href="#" onclick="Application.open(\'PAGE_MAIN\'); return false;">&#127968;</a></td>'+
		'<td width="40px"><a class="menu_button" href="#" onclick="Application.open(\'PAGE_MAIN\'); return false;">&#8592;</a></td></tr></table>';
